...
if (!empty($saveOrder))
{
    $saveOrderingUrl = 'index.php?option=com_alfa&task=orderstatuses.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
            ...
            <table class="table table-striped" id="orderList">
                ...
                <?php foreach ($this->items as $i => $item) :
                    ...
                    <tr class="row<?php echo $i % 2; ?>" data-draggable-group='1' data-transition=''>
                        ...
                        <td class="text-center">
                            <?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'orderstatuses.', $canChange, 'cb'); ?>
                        </td>

                        <td>
                            <?php if (isset($item->checked_out) && $item->checked_out && ($canEdit || $canChange)) : ?>
                                <?php echo HTMLHelper::_('jgrid.checkedout', $i, $item->uEditor, $item->checked_out_time, 'orderstatuses.', $canCheckin); ?>
                            <?php endif; ?>
                            <?php if ($canEdit) : ?>
                                <a 
