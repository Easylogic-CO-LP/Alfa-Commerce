...
if (!empty($saveOrder))
{
	$saveOrderingUrl = 'index.php?option=com_alfa&task=payments.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
				...
				<table class="table table-striped" id="paymentList">
					...
					<?php foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>" data-draggable-group='1' data-transition>
							...
							<td class="text-center">
								<?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'payments.', $canChange, 'cb'); ?>
							</td>
							...
							<td>
								...
								<?php endif; ?>
								<?php if ($canEdit) : ?>
									<a href="<?php echo Route::_('index.php?option=com_alfa&task=payment.edit&id='.(int) $item->id); ?>">
