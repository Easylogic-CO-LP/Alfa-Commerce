...
class UsergroupModel extends AdminModel
{
	 ...
	 * @since   1.0.1
	 */
	public function getTable($type = 'Usergroup', $prefix = 'Administrator', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_alfa.edit.usergroup.data', array());
	...
	/**
	 * Method to duplicate an Usergroup
	 *
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__alfa_usergroups');
				$max             = $db->loadResult();
