...
/**
 * Methods supporting a list of Customs records.
 *
 * @since  1.0.1
 */
class CustomsModel extends ListModel
{
    /**
    * Constructor.
    *
    ...
    */
    ...
    protected function getListQuery()
    {
        ...
        $query->from('`#__alfa_customs` AS a');
    ...
    public function getItems()
    {
        ...
        foreach ($items as $oneItem) {
            $oneItem->type = !empty($oneItem->type) ? Text::_('COM_ALFA_CUSTOMS_TYPE_OPTION_' . preg_replace('/[^A-Za-z0-9\_-]/', '', strtoupper(str_replace(' ', '_', $oneItem->type)))) : '';
            $oneItem->required = !empty($oneItem->required) ? Text::_('COM_ALFA_CUSTOMS_REQUIRED_OPTION_' . preg_replace('/[^A-Za-z0-9\_-]/', '', strtoupper(str_replace(' ', '_', $oneItem->required)))) : '';
        }
