...
{
	/**
	 * Method to clone existing Customs
	 *
	 * @return  void
	 *
	 * @throws  Exception
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_alfa&view=customs');
	}
	 ...
	 * @since   1.0.1
	 */
	public function getModel($name = 'Custom', $prefix = 'Administrator', $config = array())
	{
