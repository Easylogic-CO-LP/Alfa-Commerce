...
{
	/**
	 * Method to clone existing Shipments
	 *
	 * @return  void
	 *
	 * @throws  Exception
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_alfa&view=shipments');
	}
	 ...
	 * @since   1.0.1
	 */
	public function getModel($name = 'Shipment', $prefix = 'Administrator', $config = array())
	{
