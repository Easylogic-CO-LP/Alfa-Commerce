...
{
	/**
	 * Method to clone existing Usergroups
	 *
	 * @return  void
	 *
	 * @throws  Exception
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_alfa&view=usergroups');
	}
	 ...
	 * @since   1.0.1
	 */
	public function getModel($name = 'Usergroup', $prefix = 'Administrator', $config = array())
	{
