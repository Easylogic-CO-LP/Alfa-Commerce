...
class CategoryTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_alfa.category';
		parent::__construct('#__alfa_categories', 'id', $db);
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!$user->authorise('core.admin', 'com_alfa.category.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_alfa/access.xml',
				"/access/section[@name='category']/"
			);
			$default_actions = Access::getAssetRules('com_alfa.category.' . $array['id'])->getData();
			$array_jaccess   = array();
