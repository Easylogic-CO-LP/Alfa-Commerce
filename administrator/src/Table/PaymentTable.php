 ...
 * @since 1.0.1
 */
class PaymentTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!$user->authorise('core.admin', 'com_alfa.payment.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_alfa/access.xml',
				"/access/section[@name='payment']/"
			);
			$default_actions = Access::getAssetRules('com_alfa.payment.' . $array['id'])->getData();
			$array_jaccess   = array();
