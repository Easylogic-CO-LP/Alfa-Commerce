 ...
 * @since 1.0.1
 */
class ManufacturerTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_alfa.manufacturer';
		parent::__construct('#__alfa_manufacturers', 'id', $db);
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!$user->authorise('core.admin', 'com_alfa.manufacturer.' . $array['id']))
		{
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_alfa/access.xml',
				"/access/section[@name='manufacturer']/"
			);
			$default_actions = Access::getAssetRules('com_alfa.manufacturer.' . $array['id'])->getData();
			$array_jaccess   = array();
