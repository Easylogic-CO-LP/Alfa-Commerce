...
namespace Alfa\Component\Alfa\Administrator\View\Coupon;
...
/**
 * View class for a single Coupon.
 *
 * @since  1.0.1
 */
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar()
    {
        ...
        ToolbarHelper::title(Text::_('COM_ALFA_TITLE_COUPON'), "generic");
        ...
        if (!$isNew && $canDo->get('core.create')) {
            ToolbarHelper::custom('coupon.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
        }
