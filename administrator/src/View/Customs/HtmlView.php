...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar()
    {
        ...
        $formPath = JPATH_COMPONENT_ADMINISTRATOR . '/src/View/Customs';
        ...
        // Set sidebar action
        Sidebar::setAction('index.php?option=com_alfa&view=customs');
    }
    ...
    protected function getSortFields()
    {
        return [
            ...
            'a.`type`' => Text::_('COM_ALFA_CUSTOMS_TYPE'),
            'a.`name`' => Text::_('COM_ALFA_CUSTOMS_NAME'),
            'a.`required`' => Text::_('COM_ALFA_CUSTOMS_REQUIRED'),
        ];
    }
