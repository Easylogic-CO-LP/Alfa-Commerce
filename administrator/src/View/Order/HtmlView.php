...
class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null)
    {
        ...
        } elseif ($this->_layout == 'edit_payment') {
            $this->payment = null;
    ...
    protected function addPaymentEvents(&$payment)
    {
        ...
        if (empty($paymentOnAdminOrderViewEvent->getLayoutPluginName())) {
            $paymentOnAdminOrderViewEvent->setLayoutPluginName($pluginName);
        }
        if (empty($paymentOnAdminOrderViewEvent->getLayoutPluginType())) {
            $paymentOnAdminOrderViewEvent->setLayoutPluginType($pluginType);
        }
        ...
        if (empty($paymentOnAdminOrderViewLogsEvent->getLayoutPluginName())) {
            $paymentOnAdminOrderViewLogsEvent->setLayoutPluginName($pluginName);
        }
        if (empty($paymentOnAdminOrderViewLogsEvent->getLayoutPluginType())) {
            $paymentOnAdminOrderViewLogsEvent->setLayoutPluginType($pluginType);
        }
        //	check also redirect url
    ...
    protected function addShipmentEvents(&$shipment)
    {
        ...
        if (empty($shipmentOnAdminOrderViewEvent->getLayoutPluginName())) {
            $shipmentOnAdminOrderViewEvent->setLayoutPluginName($pluginName);
        }
        if (empty($shipmentOnAdminOrderViewEvent->getLayoutPluginType())) {
            $shipmentOnAdminOrderViewEvent->setLayoutPluginType($pluginType);
        }
        //	check also redirect url
        ...
        if (empty($shipmentOnAdminOrderViewLogsEvent->getLayoutPluginName())) {
            $shipmentOnAdminOrderViewLogsEvent->setLayoutPluginName($pluginName);
        }
        if (empty($shipmentOnAdminOrderViewLogsEvent->getLayoutPluginType())) {
            $shipmentOnAdminOrderViewLogsEvent->setLayoutPluginType($pluginType);
        }
        //	check also redirect url
