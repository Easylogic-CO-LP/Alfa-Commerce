...
namespace Alfa\Component\Alfa\Administrator\View\Discounts;
// No direct access
...
/**
 * View class for a list of Discounts.
 *
 * @since  1.0.1
 */
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_ALFA_TITLE_DISCOUNTS'), "generic");

		$toolbar = Toolbar::getInstance('toolbar');

		// Check if the form exists before showing the add/edit buttons
		$formPath = JPATH_COMPONENT_ADMINISTRATOR . '/src/View/Discounts';
		...
		// Set sidebar action
		Sidebar::setAction('index.php?option=com_alfa&view=discounts');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => Text::_('COM_ALFA_DISCOUNTS_NAME'),
