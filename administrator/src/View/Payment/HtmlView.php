...
namespace Alfa\Component\Alfa\Administrator\View\Payment;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_ALFA_TITLE_PAYMENT'), "generic");
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			ToolbarHelper::versions('com_alfa.payment', $this->item->id);
		}
