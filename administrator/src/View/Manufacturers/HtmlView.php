...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		$formPath = JPATH_COMPONENT_ADMINISTRATOR . '/src/View/Manufacturers';
		...
		// Set sidebar action
		Sidebar::setAction('index.php?option=com_alfa&view=manufacturers');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => Text::_('COM_ALFA_MANUFACTURERS_NAME'),
