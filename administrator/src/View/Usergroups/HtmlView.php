...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar()
    {
        ...
        $formPath = JPATH_COMPONENT_ADMINISTRATOR . '/src/View/Usergroups';
        ...
        // Set sidebar action
        Sidebar::setAction('index.php?option=com_alfa&view=usergroups');
    }
    ...
    protected function getSortFields()
    {
        return [
            ...
            'a.`name`' => Text::_('COM_ALFA_USERGROUPS_NAME'),
        ];
    }
