 ...
 * @since  1.0.1
 */
class ManufacturerModel extends ItemModel
{
	public $_item;
	...
	protected function populateState()
	{
		...
		{
			$id = Factory::getApplication()->getUserState('com_alfa.edit.manufacturer.id');
		}
		else
		{
			$id = Factory::getApplication()->input->get('id');
			Factory::getApplication()->setUserState('com_alfa.edit.manufacturer.id', $id);
		}
		...
		{
			$this->setState('manufacturer.id', $params_array['item_id']);
		}
	...
	public function getItem($id = null)
	{
		if ($this->_item === null)
		{
			...
			if (empty($id))
			{
				$id = $this->getState('manufacturer.id');
			}
	 ...
	 */
	public function getTable($type = 'Manufacturer', $prefix = 'Administrator', $config = array())
	{
