    ...
    class ItemModel extends BaseItemModel
    {
        ...
        public function getItem($pk = null): mixed
        {
            ...
            if (!isset($this->_item[$pk]))
            {
                ...
                // 2. Inject the Helper and tell it exactly which fields to grab
                MultilingualHelper::addMultilingualJoinToQuery(
                    ...
                    fields:             ['name', 'short_desc', 'full_desc'] // The helper automatically selects and aliases these!
                );

                // DELETE the manual IFNULL(NULLIF()) select statements!

                // 3. Keep the WHERE clause
