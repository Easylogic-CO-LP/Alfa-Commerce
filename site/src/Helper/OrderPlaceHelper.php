...
class OrderPlaceHelper
{
	...
	const DEFAULT_CURRENCY_NUMBER = 978;
	...
	public function getCart(): ?CartHelper { return $this->cart; }
	...
	public function placeOrder(array $data): bool
	{
		try {
			...
			try {
				...
				if (!$userInfoObject) throw new RuntimeException('Failed to save user information');
				...
				if (!$this->saveOrderItems()) throw new RuntimeException('Failed to save order items');
