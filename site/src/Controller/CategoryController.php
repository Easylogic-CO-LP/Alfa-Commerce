...
class CategoryController extends BaseController
{
    ...
    public function edit()
    {
        ...
        $previousId = (int) $this->app->getUserState('com_alfa.edit.category.id');
        $editId     = $this->input->getInt('id', 0);

        // Set the user id for the user to edit in the session.
        $this->app->setUserState('com_alfa.edit.category.id', $editId);
        ...
        $this->setRedirect(Route::_('index.php?option=com_alfa&view=categoryform&layout=edit', false));
    }
    ...
    public function publish()
    {
        ...
        if ($user->authorise('core.edit', 'com_alfa') || $user->authorise('core.edit.state', 'com_alfa')) {
            ...
            $this->app->setUserState('com_alfa.edit.category.id', null);
