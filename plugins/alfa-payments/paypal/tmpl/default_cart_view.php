<?php
	/**
	 * PayPal — cart/checkout payment method selector.
	 * Shown when PayPal is selected as the payment method.
	 * No JS widget here — the actual payment happens on PayPal's hosted page.
	 *
...
<div class="paypal-cart-info d-flex align-items-start gap-3 p-3 border rounded">
    <div class="paypal-item-badge d-flex align-items-center gap-2 mt-2">
        <svg width="54" height="54" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g>
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
            <g id="SVGRepo_iconCarrier"> <circle cx="24" cy="24" r="20" fill="#0070BA"></circle>
    ...
    <div>
        <strong>Πληρωμή με PayPal</strong>
        <p class="mb-0 text-muted small mt-1">
            Θα μεταφερθείτε στο ασφαλές περιβάλλον του PayPal για να ολοκληρώσετε την παραγγελία σας.
            Μπορείτε να πληρώσετε με το υπόλοιπο του λογαριασμού σας, ή με οποιαδήποτε χρεωστική/πιστωτική κάρτα με απόλυτη ασφάλεια.
        </p>
    </div>
</div>