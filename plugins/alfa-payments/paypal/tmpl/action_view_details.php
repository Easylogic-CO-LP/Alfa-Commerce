<?php
	/**
	 * PayPal — admin payment details modal.
	 * Shows PayPal-specific fields: PayPal Order ID, Authorization/Capture ID.
	 *
...
<?php if ($status === 'authorized'): ?>
    <div class="alert alert-info mt-3 mb-0">
        ...
        Payment is <strong>authorized</strong> but not yet captured. Use the <strong>Capture</strong> button to collect funds from PayPal when goods are shipped.
    </div>
<?php endif; ?>