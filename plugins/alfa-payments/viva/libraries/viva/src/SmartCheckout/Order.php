...
{
    public const URI = '/checkout/v2/orders';
    ...
    public function setMerchantTrns(string $ref): static
    {
        $this->merchantTrns = $ref;
        return $this;
    }
    public function setCustomerTrns(string $desc): static
    {
        $this->customerTrns = $desc;
        return $this;
    }
    ...
    public function setMaxInstallments(int $n): static
    {
    ...
    public function setCustomerFullname(string $name): static
    {
    ...
    public function setFailureUrl(string $url): static
    {
        $this->failureUrl = $url;
        return $this;
    }
    ...
    {
        $this->paymentTimeout = $seconds;
        return $this;
    }
    public function setDisableCash(bool $v): static
    {
        $this->disableCash = $v;
        return $this;
    }
    public function setDisableWallet(bool $v): static
    {
        $this->disableWallet = $v;
        return $this;
    }
    ...
    public function jsonSerialize(): array
    {
        ...
        if (!empty($this->merchantTrns)) {
            $payload['merchantTrns'] = $this->merchantTrns;
        }
        if (!empty($this->customerTrns)) {
            $payload['customerTrns'] = $this->customerTrns;
        }
        ...
        if (!empty($this->requestLang)) {
            $customer['requestLang'] = $this->requestLang;
        }
        if (!empty($customer)) {
