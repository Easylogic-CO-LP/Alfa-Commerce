<?php
/**
 * Klarna — order process error page.
 * Shown when HPP returns a failure or the session cannot be created.
 *
...
<div class="klarna-error text-center py-4">
    ...
    <h3 class="text-danger mt-3"><?php echo Text::_('PLG_ALFA_PAYMENTS_KLARNA_ERROR_TITLE'); ?></h3>
