<?php
/**
 * Klarna — admin payment details modal.
 * Shows Klarna-specific fields: KP session, Klarna order ID, fraud status.
 *
...
<div class="card">
    <div class="card-body">
        <dl class="row mb-0">
            ...
            <dt class="col-sm-4">Klarna Order ID</dt>
            <dd class="col-sm-8"><code><?php echo htmlspecialchars($payment->transaction_id); ?></code></dd>
            <?php endif; ?>

            <dt class="col-sm-4">Payment Method</dt>
            <dd class="col-sm-8"><?php echo htmlspecialchars($payment->payment_method ?? 'Klarna'); ?></dd>
...
<div class="alert alert-info mt-3 mb-0">
    ...
    Payment is <strong>authorized</strong> but not yet captured. Use the <strong>Capture</strong> button when goods are shipped.
</div>
<?php endif; ?>
