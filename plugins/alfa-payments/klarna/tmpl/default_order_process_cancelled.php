<?php
/**
 * Klarna — customer cancelled / pressed back on Klarna's page.
 *
...
<div class="klarna-cancelled text-center py-4">
    ...
    <h3 class="mt-3"><?php echo Text::_('PLG_ALFA_PAYMENTS_KLARNA_CANCELLED_TITLE'); ?></h3>
    <p class="text-muted"><?php echo Text::_('PLG_ALFA_PAYMENTS_KLARNA_CANCELLED_MSG'); ?></p>
    ...
    <div class="d-flex gap-2 justify-content-center mt-4">
        <a href="<?php echo Route::_('index.php?option=com_alfa&task=checkout.process&order_id=' . (int) $order->id); ?>"
           class="btn btn-primary">
            <?php echo Text::_('PLG_ALFA_PAYMENTS_KLARNA_TRY_AGAIN'); ?>
        </a>
        <a href="<?php echo Route::_('index.php?option=com_alfa&view=cart'); ?>"
           class="btn btn-outline-secondary">
            <?php echo Text::_('PLG_ALFA_PAYMENTS_KLARNA_BACK_TO_CART'); ?>
        </a>
    </div>
    <?php endif; ?>
</div>
