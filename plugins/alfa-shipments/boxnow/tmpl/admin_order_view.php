...
$fetchMethodID = $order->id_shipmentmethod;
$orderID = $order->id;
...
$fetchCreateLabelURL = '/administrator/index.php?option=com_alfa&task=plugin.trigger&name='
    . $fetchName . '&type=' . $fetchType . '&method_id=' . $fetchMethodID . '&func=' . $fetchCreateLabelFunction . '&format=json&order_id=' . $orderID;

// Cancel delivery.
$fetchCancelDeliveryURL = '/administrator/index.php?option=com_alfa&task=plugin.trigger&name='
    . $fetchName . '&type=' . $fetchType . '&method_id=' . $fetchMethodID . '&func=' . $fetchCancelDeliveryFunction . '&format=json&order_id=' . $orderID;
...
$fetchCancelIndividualParcelFunctionURL = '/administrator/index.php?option=com_alfa&task=plugin.trigger&name='
    . $fetchName . '&type=' . $fetchType . '&method_id=' . $fetchMethodID . '&func=' . $fetchCancelIndividualParcelFunction . '&format=json&order_id=' . $orderID;
