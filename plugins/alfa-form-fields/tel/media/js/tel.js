/**
 * alfa-form-fields/tel — client-side glue.
 *
...
(function () {
    ...
    function registerValidator() {
        if (typeof document.formvalidator === 'undefined'
            ...
            console.warn('[alfa-form-fields/tel] document.formvalidator unavailable when tel.js ran. '
                + 'Declare "form.validate" as a dependency in media/plg_alfa-form-fields_tel/joomla.asset.json.');
            return;
        }
